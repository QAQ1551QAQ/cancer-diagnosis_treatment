...
def train_metric(feature, label, save_res):
        # split data
        ...
        # compile             
        model.compile(loss=[utils.multi_category_focal_loss2(alpha=0.60, gamma=1.2)],
                optimizer= optim,
                metrics=['accuracy'])
        ...
        # save result
        with open('../result/diagnosis/%s.txt'%save_res, 'w', encoding='utf-8') as fw:
                fw.write(('%s,{},{},{},{}\n'%'mlp_focalLoss').format(acc, pre, rec, f1))
        # model save
        model.save('../result/diagnosis/model_save/%s.h5'%save_res)
...
if __name__ == '__main__':
    ...
    for i in ['all_1307','0.001_268', '0.0015_114', '0.002_46']:
        ...
        train_metric(feature, label, save_res)
